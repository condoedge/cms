...
class PageDesignForm extends Form
{
    ...
    public function render()
    {
        return _Rows(
            ...
            $this->model?->id ? null : _Html('translate.page-editor.first-save-page')->class('text-4xl flex justify-center items-center font-semibold bg-opacity-80 bg-white text-gray-800 absolute rounded-lg p-4 w-full h-full'),
        )->class('relative');
    }
