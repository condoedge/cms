...
class ArticlesTagsForm extends Modal
{
    ...
    public function body()
    {
        return _Rows(
            ...
            _Input('cms::wiki.category-name')->name('name'),
            _ButtonGroup('cms::wiki.tag-type')
                ...
                ->class('mb-2')->options([
                    'categorie' => 'cms::wiki.category',
                    'subcategorie' => 'cms::wiki.subcategory',
                ])->name('type', false)->default('categorie')->selfGet('getTypeInputs')->inPanel('type_inputs'),
            _Panel()->id('type_inputs'),
            _FlexEnd(
                _SubmitButton('cms::wiki.save')->closeModal()->refresh(ArticleCategoriesForm::ID),
            )->class('mt-4'),
        );
    }
    ...
    public function getTypeInputs()
    {
        ...
        return _Select('cms::wiki.category-parent')->options(
